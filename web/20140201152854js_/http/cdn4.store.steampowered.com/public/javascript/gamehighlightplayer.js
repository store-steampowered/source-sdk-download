...
var HighlightPlayer = Class.create( {
	...
	LoadMovie: function( id )
	{
		...
		if ( $(strTarget) && $(strTarget).tagName == 'DIV' )
		{
			...
			swfobject.embedSWF( "https://web.archive.org/web/20140201152854/http://cdn2.store.steampowered.com/public/swf/videoPlayer.swf?v=10", strTarget, rgFlashVars['STAGE_WIDTH'], rgFlashVars['STAGE_HEIGHT'], strRequiredVersion, false, rgFlashVars, {wmode: "opaque", allowScriptAccess: "always", allowFullScreen: "true" } );
			if ( $(strTarget) && $(strTarget).tagName == 'DIV' )
			{
	...
	RecordView: function( movieid )
	{
		...
		{
			new Ajax.Request( 'https://web.archive.org/web/20140201152854/http://store.steampowered.com/videoview/' + movieid + '/' );
		}
	}
} );
...
/*
     FILE ARCHIVED ON 15:28:54 Feb 01, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:54:06 Nov 26, 2022.
