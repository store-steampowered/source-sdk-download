...
{
	var rgParams = { url: 'https://web.archive.org/web/20140131214117/http://steamcommunity.com/' + path };
	if ( method )
		rgParams.type = method;

	// if this js file was hosted off the store, add CORS request headers
	if ( window.location.href.indexOf( 'https://web.archive.org/web/20140131214117/http://steamcommunity.com/' ) != 0 )
	{
...
{
	return {
		url: 'https://web.archive.org/web/20140131214117/http://cdn.steamcommunity.com/' + this.m_strURL,
		dataType: 'jsonp',
...
{
	var el = $(elem);
	var youtubeurl = 'https://web.archive.org/web/20140131214117/http://www.youtube.com/embed/' + videoid + '?showinfo=0&autohide=1&fs=1&hd=1&modestbranding=1&rel=0&showsearch=0&wmode=direct&autoplay=1';
...
/*
     FILE ARCHIVED ON 21:41:17 Jan 31, 2014 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:54:04 Nov 26, 2022.
...
/*
playback timings (ms):
  captures_list: 179.05
  exclusion.robots: 0.263
  exclusion.robots.policy: 0.254
  RedisCDXSource: 0.926
  esindex: 0.01
  LoadShardBlock: 158.572 (3)
  PetaboxLoader3.datanode: 190.619 (5)
  CDXLines.iter: 16.263 (3)
  load_resource: 337.344 (2)
  PetaboxLoader3.resolve: 232.081 (2)
*/